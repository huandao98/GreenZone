...
<head>
    ...
    <title>GreenZone - Thanh toán đơn hàng</title>
        ...
        <div class="wrap">
            ...
            <div class="main">
                <div class="main-header">
                    <a href="/" class="logo">
                        <h1 class="logo-text">GreenZone</h1>
                    </a>
                    <ul class="breadcrumb">
                            ...
                            <div class="section">
                                ...
                                <div class="section-content section-customer-information no-mb">
                                    <div class="logged-in-customer-information">&nbsp;
                                        ...
                                        @else
                                        <p class="logged-in-customer-information-paragraph"><a href="{{ url('customers/login') }}">Đăng nhập</a></p>
                                        @endif
                                    </div>
                                    <div class="fieldset">
