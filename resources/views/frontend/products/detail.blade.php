                ...
                <div class="row product-detail-main pr-style">
                    <div class="col-md-6">
                        <div class="product-gallery">
                            <img src="{{ asset('upload/products/'.$record->photo) }}" width="600px">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <form id="add-item-form" action="" method="post" class="variants clearfix">
                            <div class="select-swatch clearfix">
                                <div id="variant-swatch-0" class="swatch clearfix" data-option="option1" data-option-index="0">
                                    <div class="header-swatch">Màu:	</div>
                                    <div class="select-swap clearfix">
                                        <div class="n-sd swatch-element">
                                            <input class="variant-0" id="gold" type="radio" name="option1" value="Gold" checked="">
                                            <label for="gold" class="sd">
                                                <span>Gold</span>
                                            </label>
                                        </div>
                                        <div class="n-sd swatch-element">
                                            <input class="variant-0" id="Black" type="radio" name="option1" value="Black">
                                            <label for="Black">
                                                <span>Black</span>
                                            </label>
                                        </div>
