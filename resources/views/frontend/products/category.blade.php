    ...
    <div class="container-fluid">
        <div>
            <ol class="breadcrumb breadcrumb-arrows">
                ...
                <li><span>{{ isset($category->name) ? $category->name : '' }}</span></li>
            </ol>
        </div>
    </div>
</div>
...
<div class="collection-page">
    <div class="banner-collection text-center">
        <img src="{{ asset('frontend/images/banner-collect.png') }}">
    </div>
                                ...
                                <div class="sortFilter">
                                    <div class="collection-sort">
                                        <div class="sortby-option browse-tag option">
                                            ...
                                            <span>
                                                <select class="custom-dropdown" aria-label="sort-by" onchange="location.href = '{{ url('products/category/'.$category_id.'?order=') }}'+this.value;">
